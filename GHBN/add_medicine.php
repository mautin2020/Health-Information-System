...
<select name="medicine_category" class="form-control">
    ...
    <option value="α blockers"<?php if (isset($trimmed['medicine_category']) && ($trimmed['medicine_category'] == 'α blockers')) echo ' selected="selected"';?>>α Blockers</option>
    <option value="β-receptor blockers"<?php if (isset($trimmed['medicine_category']) && ($trimmed['medicine_category'] == 'β-receptor blockers')) echo ' selected="selected"';?>>β-receptor blockers</option>
