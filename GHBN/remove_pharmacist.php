<?php # remove_pharmacist.php 
// This page is for removing pharmacist.
// This page is accessed through pharmacist_list.php. 

$page_title = 'Remove a Pharmacist';
        ...
        echo '<p>The user has NOT been removed.</p>';
            ...
            if (mysqli_num_rows($r) == 1) {// Valid user ID, show the form.
                ...
                // Get the user's information:
                    ...
                    <a href="nurses_list.php" class="btn btn-primary">Go Back</a>
                    <div class="row pt-md-5 mt-md-3 mb-5">
                    <div class="row mb-4 align-items-center">
                    <div class="container-fluid bg-white row py-3 mb-4 task-border align-items-center">';
                    echo "<h4>Name: $row[0]</h4>";
                   echo' <br />
                   <div>Are you sure you want to remove this user from Pharmacist list?</div>';
                      // Create the form:
                     echo '<form action="remove_pharmacist.php" method="post">
