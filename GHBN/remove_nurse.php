<?php # remove_nurse.php 
// This page is for removing nurse.
// This page is accessed through nurses_list.php. 

$page_title = 'Remove a Nurse';
        ...
        echo '<p>The user has NOT been removed.</p>';
            ...
            if (mysqli_num_rows($r) == 1) {// Valid user ID, show the form.
                ...
                // Get the user's information:
                   ...
                   echo' <br />
                   <div>Are you sure you want to remove this user from nurses\' list?</div>';
                      // Create the form:
